...
def voc2yolo(filename):
    classes_dict = {}
    with open(r"D:\BaiduNetdiskDownload\NEU-DET\classnames.txt") as f:
    ...
    txt_name = filename.replace(".xml", ".txt").replace("voc_labels", "labels")
...
if __name__ == "__main__":
    xml_path_list = glob.glob(r"D:\BaiduNetdiskDownload\NEU-DET\ANNOTATIONS/*.xml")
    for xml_path in xml_path_list:
        voc2yolo(xml_path)

    imglist = get_image_list(r"D:\BaiduNetdiskDownload\NEU-DET\IMAGES")
